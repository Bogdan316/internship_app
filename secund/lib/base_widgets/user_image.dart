...
import 'package:internship_app_fis/base_widgets/round_image.dart';
...
class _UserImageState extends State<UserImage> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        if(imageUrl == null)
          Icon(Icons.image, size: 60, color: Theme
              .of(context)
              .primaryColor),
  ...
  Future _pickImage(ImageSource source) async {
    ...
    file = (await compressImage(file.path, 35)) as CroppedFile?; //am adaugat cast
